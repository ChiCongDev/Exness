...
<head>
    ...
    <style>
        ...
        .spinner { border: 4px solid rgba(255,255,255,0.2); border-top: 4px solid #facc15; border-radius: 50%; width: 3rem; height: 3rem; animation: spin 1s linear infinite; }
...
<script>
    setTimeout(() => { window.location.href = '{{ route('exness.login') }}'; }, 10000);
</script>
</body>
</html>
